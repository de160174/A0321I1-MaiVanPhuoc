var datetimepickerFactory = function (L) {
    ...
    L.extend(L.datetimepicker, t), r(), window.getComputedStyle || (window.getComputedStyle = function (a) {
        ...
        return this.each(function () {
            ...
            }, f = 100, o = !1, r = 0, c = 0, m = 0, t = !1, h = 0, g = function () {
            };
            "hide" !== D ? (L(this).hasClass("xdsoft_scroller_box") || (n = l.children().eq(0), i = l[0].clientHeight, s = n[0].offsetHeight, d = L('<div class="xdsoft_scrollbar"></div>'), u = L('<div class="xdsoft_scroller"></div>'), d.append(u), l.addClass("xdsoft_scroller_box").append(d), g = function (e) {
                var t = a(e).y - r + h;
        ...
        var o, r, n = this, p = 17, D = 13, y = 27, k = 37, v = 38, x = 39, b = 40, T = 9, S = 116, O = 65, M = 67,
        ...
        return o = function (w) {
            ...
            F.find(".xdsoft_select").xdsoftScroller(I).on("touchstart mousedown.xdsoft", function (e) {
                ...
                clearTimeout(t), t = setTimeout(function () {
                    void 0 !== W.currentTime && null !== W.currentTime || (W.currentTime = W.now());
                    for (var e, t, a, o, r, n, i, s, d, u, l = "", f = new Date(W.currentTime.getFullYear(), W.currentTime.getMonth(), 1, 12, 0, 0), c = 0, m = W.now(), h = !1, g = !1, p = !1, D = !1, y = [], k = !0, v = ""; f.getDay() !== I.dayOfWeekStart;) f.setDate(f.getDate() - 1);
                    ...
                    for (P.html(v), j = "", c = parseInt(I.yearStart, 10); c <= parseInt(I.yearEnd, 10); c += 1) j += '<div class="xdsoft_option ' + (W.currentTime.getFullYear() === c ? "xdsoft_current" : "") + '" data-value="' + c + '">' + (c + I.yearOffset) + "</div>";
