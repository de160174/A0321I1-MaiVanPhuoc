...
public class Contract {
    ...
    public Contract(String contract_id, String contract_start_date, String contract_end_date, double contract_deposit, double contract_total_money, String employee_id, String customer_id, String service_id) {
        this.contract_id = contract_id;
