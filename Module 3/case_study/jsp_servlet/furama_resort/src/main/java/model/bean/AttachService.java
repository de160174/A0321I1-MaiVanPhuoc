...
public class AttachService {
    ...
    public AttachService(String attach_service_id, String attach_service_name, Double attach_service_cost, int attach_service_unit, String attach_service_status) {
